  ...
  <div id="coursecolumn">
    ...
    <div>
      ...
      <el-table ref="singleTable" :data="list" highlight-current-row style="width: 100%" v-loading='loading'>
        <el-table-column property="termName" label="一级品种名称" style="width:30%">
        </el-table-column>
    ...
    <el-dialog :title="coursecolumn.id?'修改一级品种':'添加一级品种'" :visible.sync="dialogVisible" width="50%">
      <el-row>
  ...
  export default {
    ...
    methods: {
      show: function(pageNo){
        ...
        services.coursecolumn_listFirst(params)
        .then((res) => {
      ...
      handleEdit: function(row){
        this.dialogVisible = true;
        let editObj =  JSON.parse(JSON.stringify(row));
        this.coursecolumn = editObj;
      },
