...
<script>
    ...
    import {getCatg,getListItem} from "../../service/test";
    ...
    export default {
            ...
            return {
                config: [
                    ...
                    new type.UploadImg({
                        ...
                        //url:'/img',
                        //rules:[{required:true,message:'请上传图片',trigger:'blur'}]  //没用
                    }),
                    new type.Editor({
                        key: 'ftext',
                        label: '富文本',
        ...
        mounted: function () {
            console.log(this)
            setTimeout(() => {
                this.$refs.myForm.resetFormData({age: 18, time: new Date(), radio: '已婚', test: 10,gender:0,catg:[10,11]});
            }, 2000)
        },
        methods: {
            submit: function (e) {
